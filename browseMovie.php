...
<div class = "column left" style="background-color:black"> 
 <form method = "get" action = "browseMovie.php">
...
<div class = "column right">
 ...
 <?php
	...
	$movieCategoryQuery = createMovieQuery($searchKeys);
	$movieCategoryResult = mysqli_query($db_connection, $movieCategoryQuery);	
	?>
 <table>
  <tr><td>MovieTitle</td><td>Production Year</td></tr>
  <?php
	displayTable($movieCategoryResult);
  ?>
 </table>
