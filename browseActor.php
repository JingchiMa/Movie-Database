...
<div class = "column left" style="background-color:black"> 
 <form method = "get" action = "browseActor.php">
...
<div class = "column right">
 ...
 <?php
	...
	$actorCategoryQuery = createPersonQuery($searchKeys, "Actor");
	$actorCategoryResult = mysqli_query($db_connection, $actorCategoryQuery);	
	?>
 <table>
  <tr><td>Actor Name</td><td>Date of Birth</td></tr>
  <?php
	displayTable($actorCategoryResult);
  ?>
 </table>
